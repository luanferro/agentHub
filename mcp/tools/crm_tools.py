...
async def listar_empresas() -> str:
    ...
    async with httpx.AsyncClient() as client:
        response = await client.get(f"{CRM_API_URL}/crm/v1/empresa/")
...
async def buscar_empresa(empresa_id: str) -> str:
    ...
    async with httpx.AsyncClient() as client:
        response = await client.get(f"{CRM_API_URL}/crm/v1/empresa/{empresa_id}")
        return response.text
...
async def criar_empresa(nome: str, cnpj: str, endereco: str, ramo: str, razao_social: str) -> str:
    ...
    async with httpx.AsyncClient() as client:
        ...
        response = await client.post(f"{CRM_API_URL}/crm/v1/empresa/", json=payload)
        return response.text
...
async def listar_contatos() -> str:
    ...
    async with httpx.AsyncClient() as client:
        response = await client.get(f"{CRM_API_URL}/crm/v1/contato/")
        return response.text
...
async def buscar_contato(contato_id: str) -> str:
    ...
    async with httpx.AsyncClient() as client:
        response = await client.get(f"{CRM_API_URL}/crm/v1/contato/{contato_id}")
        return response.text
...
async def criar_contato(nome: str, email: str, telefone: str, empresa_id: int) -> str:
    ...
    async with httpx.AsyncClient() as client:
        ...
        response = await client.post(f"{CRM_API_URL}/crm/v1/contato/", json=payload)
        return response.text