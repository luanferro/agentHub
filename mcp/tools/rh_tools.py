...
async def listar_funcionarios() -> str:
    ...
    async with httpx.AsyncClient() as client:
        response = await client.get(f"{RH_API_URL}/rh/v1/funcionario/")
...
async def buscar_funcionario(funcionario_id: str) -> str:
    ...
    async with httpx.AsyncClient() as client:
        response = await client.get(f"{RH_API_URL}/rh/v1/funcionario/{funcionario_id}")
        return response.text
...
async def criar_funcionario(nome: str, email: str, cpf: str, data_admissao: str, cargo: str, salario: float) -> str:
    ...
    async with httpx.AsyncClient() as client:
        ...
        response = await client.post(f"{RH_API_URL}/rh/v1/funcionario/", json=payload)
        return response.text    
...
async def listar_departamentos() -> str:
    ...
    async with httpx.AsyncClient() as client:
        response = await client.get(f"{RH_API_URL}/rh/v1/departamento/")
        return response.text
...
async def buscar_departamento(departamento_id: str) -> str:
    ...
    async with httpx.AsyncClient() as client:
        response = await client.get(f"{RH_API_URL}/rh/v1/departamento/{departamento_id}")
        return response.text
...
async def criar_departamento(nome: str, descricao: str) -> str:
    ...
    async with httpx.AsyncClient() as client:
        ...
        response = await client.post(f"{RH_API_URL}/rh/v1/departamento/", json=payload)
        return response.text